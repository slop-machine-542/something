...
CURATED_LINKS = [
    ...
    # Additional Articles
    {"title": "The Mathematics of Machine Learning", "url": "https://towardsdatascience.com/mathematics-of-machine-learning-3e5855d70f1e", "description": "Comprehensive guide to the mathematical foundations of ML algorithms.", "high": "Applied Math", "low": "machine learning"},
    {"title": "Understanding Eigenvalues and Eigenvectors", "url": "https://www.mathsisfun.com/algebra/eigenvalue.html", "description": "Visual guide to understanding what eigenvalues and eigenvectors really mean.", "high": "Algebra", "low": "linear algebra"},
    {"title": "The Beauty of the Fourier Transform", "url": "https://www.youtube.com/watch?v=spUNpyF58BY", "description": "3Blue1Brown explains how the Fourier transform decomposes signals into frequencies.", "high": "Analysis", "low": "fourier analysis"},
    {"title": "Introduction to Graph Theory", "url": "https://www.tutorialspoint.com/graph_theory/index.htm", "description": "Comprehensive tutorial covering graphs, trees, and network flows.", "high": "Discrete Math", "low": "graph theory"},
    {"title": "Bayesian Statistics Explained", "url": "https://towardsdatascience.com/bayesian-statistics-explained-to-beginners-7089027a3e1", "description": "Beginner-friendly explanation of Bayesian inference and its applications.", "high": "Probability", "low": "bayesian statistics"},
    {"title": "The Riemann Hypothesis Explained", "url": "https://www.youtube.com/watch?v=GFhzqFvO3FU", "description": "Numberphile explains the most famous unsolved problem in mathematics.", "high": "Number Theory", "low": "riemann hypothesis"},
    {"title": "Topology Explained - Topology Jokes", "url": "https://www.youtube.com/watch?v=tds0qoxWVss", "description": "How topologists view the world differently - donuts and coffee cups are the same!", "high": "Topology", "low": "introduction"},
    {"title": "What is Category Theory?", "url": "https://www.youtube.com/watch?v=ho7oagHeqNc", "description": "Introduction to the mathematics of mathematics - the study of structure.", "high": "Logic", "low": "category theory"},
    {"title": "The Math Behind Bitcoin", "url": "https://www.youtube.com/watch?v=bBC-nXj3Ng4", "description": "How elliptic curve cryptography secures cryptocurrency transactions.", "high": "Number Theory", "low": "cryptography"},
    {"title": "Understanding Markov Chains", "url": "https://brilliant.org/wiki/markov-chains/", "description": "Interactive explanation of Markov chains and their applications in modeling.", "high": "Probability", "low": "markov chains"},
    {"title": "The Four Color Theorem", "url": "https://www.youtube.com/watch?v=42-ws3bkrKM", "description": "How computers helped prove that any map can be colored with just four colors.", "high": "Discrete Math", "low": "graph theory"},
    {"title": "Gödel's Incompleteness Theorem", "url": "https://www.youtube.com/watch?v=HeQX2HjkcNo", "description": "The theorem that changed mathematics by proving some truths are unprovable.", "high": "Logic", "low": "incompleteness"},
    {"title": "Introduction to Differential Geometry", "url": "https://www.maths.ed.ac.uk/~v1ranick/papers/diffgeombook.pdf", "description": "Free comprehensive textbook on curves and surfaces in 3D space.", "high": "Geometry", "low": "differential geometry"},
    {"title": "Game Theory in Economics", "url": "https://www.investopedia.com/terms/g/gametheory.asp", "description": "How mathematical models of strategic interaction explain economic behavior.", "high": "Applied Math", "low": "game theory"},
    {"title": "The Birthday Paradox", "url": "https://www.youtube.com/watch?v=ofTb57aZHZs", "description": "Why you only need 23 people for a 50% chance of shared birthdays.", "high": "Probability", "low": "paradoxes"},
    {"title": "Monte Carlo Methods", "url": "https://towardsdatascience.com/monte-carlo-simulations-in-python-f4a6c4948c21", "description": "Using randomness to solve deterministic problems in science and finance.", "high": "Applied Math", "low": "numerical methods"},
    {"title": "The Pigeonhole Principle", "url": "https://brilliant.org/wiki/pigeonhole-principle/", "description": "Simple yet powerful combinatorial principle with surprising applications.", "high": "Discrete Math", "low": "combinatorics"},
    {"title": "Calculus Made Easy", "url": "http://calculusmadeeasy.org/", "description": "Classic book by Silvanus Thompson making calculus accessible to everyone.", "high": "Analysis", "low": "calculus"},
    {"title": "Visual Group Theory", "url": "https://www.youtube.com/playlist?list=PLwV-9DG53NDxU631sT-WkCsLgxYpMKg9E", "description": "Beautiful visual approach to understanding group theory concepts.", "high": "Algebra", "low": "group theory"},
    {"title": "The Banach-Tarski Paradox", "url": "https://www.youtube.com/watch?v=s86-Z-CbaHA", "description": "How to cut a sphere into pieces and reassemble it into two identical spheres.", "high": "Logic", "low": "measure theory"},
    {"title": "Introduction to Topology", "url": "https://www.youtube.com/playlist?list=PLpG_ISEhE6bVeCSx7Qtz2R_t9oJ7r_8F8", "description": "Tadashi Tokieda's intuitive introduction to topological concepts.", "high": "Topology", "low": "introduction"},
    {"title": "The Isoperimetric Inequality", "url": "https://www.youtube.com/watch?v=2dI9OLwZ8yg", "description": "Why the circle encloses the most area for a given perimeter.", "high": "Geometry", "low": "optimization"},
    {"title": "Understanding p-adic Numbers", "url": "https://www.youtube.com/watch?v=3gyHKCDq1YA", "description": "An alternative way to measure distance that leads to strange and beautiful mathematics.", "high": "Number Theory", "low": "p-adic analysis"},
    {"title": "The Collatz Conjecture", "url": "https://www.youtube.com/watch?v=094y1Z2wpJg", "description": "The simplest unsolved problem in mathematics that anyone can understand.", "high": "Number Theory", "low": "unsolved problems"},
    {"title": "Introduction to Knot Theory", "url": "https://www.math.ucla.edu/~radko/191.1.05w/knots.pdf", "description": "Free notes on the mathematics of knots and their invariants.", "high": "Topology", "low": "knot theory"},
    {"title": "The Central Limit Theorem", "url": "https://www.youtube.com/watch?v=JNm3M9cqWyc", "description": "Why bell curves appear everywhere in nature and statistics.", "high": "Probability", "low": "statistics"},
    {"title": "Non-Euclidean Geometry", "url": "https://www.youtube.com/watch?v=zQo_S2GyLwg", "description": "How mathematicians discovered geometry where parallel lines can meet.", "high": "Geometry", "low": "non-euclidean"},
    {"title": "The Fast Fourier Transform", "url": "https://www.youtube.com/watch?v=h7apO7q16V0", "description": "The algorithm that revolutionized signal processing and data analysis.", "high": "Applied Math", "low": "algorithms"},
    {"title": "Introduction to Manifolds", "url": "https://www.math.toronto.edu/mgualt/MAT1300/week1.pdf", "description": "Introduction to the spaces that locally look like Euclidean space.", "high": "Topology", "low": "manifolds"},
    {"title": "The Golden Ratio", "url": "https://www.youtube.com/watch?v=5zosU6XTgSY", "description": "The mathematics and mythology behind nature's supposed favorite number.", "high": "Number Theory", "low": "golden ratio"},
    {"title": "Linear Programming", "url": "https://www.youtube.com/watch?v=B3biWsBLeNc", "description": "How to optimize linear objective functions subject to constraints.", "high": "Applied Math", "low": "optimization"},
    {"title": "The Axiom of Choice", "url": "https://www.youtube.com/watch?v=PC0_CTzoM1E", "description": "A controversial axiom with surprising and counterintuitive consequences.", "high": "Logic", "low": "set theory"},
    {"title": "Introduction to Information Theory", "url": "https://www.youtube.com/watch?v=_PG-jJKBIPk", "description": "Claude Shannon's mathematical theory of communication and entropy.", "high": "Applied Math", "low": "information theory"},
    {"title": "The Ham Sandwich Theorem", "url": "https://www.youtube.com/watch?v=tVjTg6A1Ues", "description": "Why you can always fairly split a ham sandwich between two thieves with one cut.", "high": "Topology", "low": "fair division"},
    {"title": "Partial Differential Equations", "url": "https://www.youtube.com/watch?v=LYs_sT7nHPI", "description": "Introduction to the equations that describe heat, waves, and fluid flow.", "high": "Applied Math", "low": "pdes"},
    {"title": "The Sylow Theorems", "url": "https://www.youtube.com/watch?v=6VIb9k3aT4k", "description": "Fundamental theorems about the structure of finite groups.", "high": "Algebra", "low": "group theory"},
    {"title": "Ramanujan's Infinite Series", "url": "https://www.youtube.com/watch?v=j-ZAy8bFgX0", "description": "The self-taught mathematician's miraculous formulas for pi.", "high": "Number Theory", "low": "series"},
    {"title": "The Jordan Curve Theorem", "url": "https://www.youtube.com/watch?v=CS4uyQcE5-Q", "description": "Why every simple closed curve divides the plane into inside and outside.", "high": "Topology", "low": "plane topology"},
    {"title": "Introduction to Measure Theory", "url": "https://www.youtube.com/watch?v=74JrB1jVr7o", "description": "The rigorous foundation of integration and probability.", "high": "Analysis", "low": "measure theory"},
    {"title": "The Monty Hall Problem", "url": "https://www.youtube.com/watch?v=4Lb-6rxZxx0", "description": "The counterintuitive probability puzzle that fooled thousands.", "high": "Probability", "low": "conditional probability"},
    {"title": "Understanding Tensor Calculus", "url": "https://www.youtube.com/watch?v=CliW7kSxxWU", "description": "Introduction to the mathematics behind general relativity.", "high": "Geometry", "low": "tensor calculus"},
    {"title": "The Hairy Ball Theorem", "url": "https://www.youtube.com/watch?v=c0gDLEHbC6Y", "description": "Why you can't comb a hairy ball flat without creating a cowlick.", "high": "Topology", "low": "vector fields"},
    {"title": "Stochastic Calculus", "url": "https://www.youtube.com/watch?v=f7R1fF3wJzQ", "description": "The mathematics of random processes used in finance.", "high": "Probability", "low": "stochastic processes"},
    {"title": "The ABC Conjecture", "url": "https://www.youtube.com/watch?v=HI7eKI01aPo", "description": "A deep problem connecting addition and multiplication of integers.", "high": "Number Theory", "low": "abc conjecture"},
    {"title": "Introduction to Algebraic Topology", "url": "https://www.youtube.com/playlist?list=PLpRLWqLFLVSBL2OSrdqEY3zRktTqUjL8A", "description": "Using algebra to study holes and connectivity in spaces.", "high": "Topology", "low": "algebraic topology"},
